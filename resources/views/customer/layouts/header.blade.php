    ...
    <section class="top-header">
        <section class="container-xxl ">
            <section class="d-flex justify-content-between align-items-center py-3">
                <section class=""><a class="text-decoration-none" href="{{ route('customer.home') }}"><img
                            src="{{ asset('customer-assets/images/logo/8.png') }}" alt="logo"></a></section>
                <section class="search-wrapper">
                    <section class="search-box">
                        ...
                        <section class="search-result search-box-active h-auto visually-hidden border-0 rounded-bottom " id="search-result"></section>
                    </section>
                </section>
                    ...
                    <section>
                        <section class="d-inline px-3">
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                                ...
                                <section><a class="dropdown-item" href="{{ route('profile.my-profile') }}"><i
                                ...
                                <section><a class="dropdown-item" href="{{ route('profile.my-favorites') }}"><i
                                            class="fa fa-heart"></i>لیست
                                        علاقه مندی</a></section>
                                <section>
                                    <hr class="dropdown-divider">
                                </section>
                                <section><a class="dropdown-item" href="{{ route('customer.logout') }}"><i
                    ...
                    @guest
                        <section>
                            <section class="d-inline px-3">
                                ...
                                <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                                    ...
                                    <section><a class="dropdown-item" href="{{ route('customer.login-register') }}"><i
                                                class="fa fa-lock"></i> ورود / ثبت نام </a>
                                    </section>
                        ...
                        <section class="header-cart d-inline ps-3 border-start position-relative">
                            <a class="btn btn-link position-relative text-dark header-cart-link"
                                href="{{ route('customer.shopping.cart') }}">
                                <i class="fa fa-shopping-cart"></i>
                                @if (isset($carts))
                                    <span style="top: 80%;"
                                        class="position-absolute start-0 translate-middle badge rounded-pill bg-danger">{{ $carts->count() ?? 0 }}</span>
                                @endif
                            </a>
                            @if (isset($carts))
                                <section class="header-cart-dropdown">
                                    <section class="border-bottom d-flex justify-content-between p-2">
                                        <span class="text-muted">{{ persianNumber($carts->count() ?? 0) }} کالا</span>
                                        <a class="text-decoration-none text-info"
                                            href="{{ route('customer.shopping.cart') }}">مشاهده سبد خرید </a>
                                    </section>
                                    <section class="header-cart-dropdown-body">
                                        ...
                                        @foreach ($carts as $item)
                                            @php
                                                $finalPrice += $item->itemFinalPrice();
                                            @endphp
                                            <section
                                                class="header-cart-dropdown-body-item d-flex justify-content-start align-items-center">
                                                <img class="flex-shrink-1" src="{{ asset($item->product->image) }}"
                                                    alt="">
                                                <section class="w-100 text-truncate"><a
                                                        class="text-decoration-none text-dark"
                                                        href="#">{{ $item->product->name }}</a></section>
                                                <form action="{{ route('customer.shopping.cart.destory', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                    ...
                                    <section
                                        ...
                                        <section class="">
                                            ...
                                            <section> {{ priceFormat($finalPrice) }} تومان</section>
                                        </section>
                                        <section class=""><a class="btn btn-danger btn-sm d-block"
                                                href="{{ route('customer.address-delivery') }}">ثبت سفارش</a></section>
                                    </section>
                                </section>
                            @endif
                        </section>
