    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.content.page.update' , $page->slug) }}" method="POST">
                        @csrf
                        @method('put')
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control form-control-sm" id="status" name="status">
                                        <option value="0" {{ old('status' , $page->status) == 0 ? 'selected' : '' }}>غیرفعال</option>
                                        <option value="1" {{ old('status' , $page->status) == 1 ? 'selected' : '' }}>فعال</option>
                                    </select>
                                </div>
                                @error('status')
                                    <div class="mt-1">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="tags" value="{{ old('tags' , $page->tags) }}" name="tags">
