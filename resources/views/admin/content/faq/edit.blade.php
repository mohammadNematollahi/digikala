...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> بروز رسانی سوال</li>
        </ol>
    </nav>
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.content.faq.update' , $fAQ->slug) }}" method="POST">
                        @csrf
                        @method('put')
                        <section class="row">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="question"
                                        id="question" value="{{ old('question' , $fAQ->question) }}">
                                </div>
                                @error('question')
                                    <div class="mt-1">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control form-control-sm" id="status" name="status">
                                        <option value="0" {{ old('status' , $fAQ->status) == 0 ? 'selected' : '' }}>غیرفعال</option>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="tags" value="{{ old('tags' , $fAQ->tags) }}" name="tags">
