                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control form-control-sm" id="activation" name="activation">
                                        <option value="0" {{ old('activation') == 0 ? 'selected' : '' }}>غیرفعال</option>
                                        <option value="1" {{ old('activation') == 1 ? 'selected' : '' }}>فعال</option>
                                    </select>
                                </div>
                                @error('activation')
                                    <div class="mt-1">
