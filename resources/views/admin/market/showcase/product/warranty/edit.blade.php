    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <form action="{{ route('admin.market.showcase.warranty.update', [$product->slug , $warranty->id]) }}" method="POST">
                    @csrf
                    @method('put')
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name' , $warranty->name) }}"
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="price_increase" value="{{ old('price_increase' , $warranty->price_increase) }}"
                                    class="form-control form-control-sm">
                            </div>
