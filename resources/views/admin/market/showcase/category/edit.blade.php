    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.market.showcase.category.update', $category->slug) }}" method="POST"
                        ...
                        <section class="row">
                                    ...
                                    <select name="parent_id" id="parent_id" class="form-control form-control-sm">
                                        ...
                                        @foreach ($parent_menus as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('parent_id', $category->parent_id) == $category->parent_id ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control form-control-sm" id="show_in_menu"
                                        name="show_in_menu">
                                        <option value="0"
                                            {{ old('show_in_menu', $category->show_in_menu) == 0 ? 'selected' : '' }}>غیرفعال
                                        </option>
                                        <option value="1"
                                            {{ old('show_in_menu', $category->show_in_menu) == 1 ? 'selected' : '' }}>فعال
                                        </option>
                                    </select>
                                </div>
                                @error('show_in_menu')
