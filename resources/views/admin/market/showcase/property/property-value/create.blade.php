    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.market.showcase.property.value.store' , $attribute->id) }}" method="POST">
                        @csrf
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="product_id" id="product_id" class="form-control form-control-sm">
                                        ...
                                        @foreach ($attribute->category->products as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('product_id') == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="price_increase"
                                        name="price_increase" value="{{ old('price_increase') }}">
                                </div>
