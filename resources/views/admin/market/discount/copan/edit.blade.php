                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="code"
                                        name="code" value="{{old("code" , $copan->code)}}">
                                </div>
                                @error('code')
                                    <div class="mt-1">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="amount"
                                        name="amount" value="{{old("amount" , $copan->amount)}}">
                                </div>
                                @error('amount')
                                    <div class="mt-1">
                                        <p class="text-danger">{{ $message }}</p>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="amount_type" id="amount_type" class="form-control form-control-sm">
                                        <option value="0" {{ old('amount_type' , $copan->amount_type) == 0 ? 'selected' : '' }}>درصد</option>
                                        <option value="1" {{ old('amount_type' , $copan->amount_type) == 1 ? 'selected' : '' }}>تومان</option>
                                    </select>
                                </div>
                                @error('amount_type')
                                    <div class="mt-1">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="discount_ceiling"
                                        name="discount_ceiling" value="{{old("discount_ceiling" , $copan->discount_ceiling)}}">
                                </div>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="user_id" id="user_id" class="form-control form-control-sm">
                                        <option value="">اگر کپن شما خصوصی بود یکی از این گزینه های را انتخاب کنید
                                        </option>
                                        @foreach ($users as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('user_id' , $copan->user_id) == $item->id ? 'selected' : '' }}>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control form-control-sm" id="status" name="status">
                                        <option value="0" {{ old('status' , $copan->status) == 0 ? 'selected' : '' }}>غیرفعال</option>
