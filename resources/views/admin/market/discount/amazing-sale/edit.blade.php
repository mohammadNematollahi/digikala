                                    ...
                                    <select class="select2 form-control form-control-sm" id="product_id" name="product_id">
                                        ...
                                        @foreach ($products as $item)
                                            <option value="{{ $item->id }}"
                                                {{ old('product_id' , $amazingSale->product_id) == $item->id ? 'selected' : '' }}>
                                                {{ $item->id . ' ' . $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="percentage"
                                        name="percentage" value="{{ old('percentage' , $amazingSale->percentage) }}">
                                </div>
                                @error('percentage')
                                    <div class="mt-1">
                                        <p class="text-danger">{{ $message }}</p>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control form-control-sm" id="status" name="status">
                                        <option value="0" {{ old('status' , $amazingSale->status) == 0 ? 'selected' : '' }}>غیرفعال</option>
