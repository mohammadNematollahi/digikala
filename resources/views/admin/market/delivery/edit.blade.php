                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="delivery_time"
                                        name="delivery_time" value="{{ old('delivery_time' , $delivery->delivery_time) }}">
                                </div>
                                @error('delivery_time')
                                    <div class="mt-1">
                                        <p class="text-danger">{{ $message }}</p>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="delivery_time_unit"
                                        name="delivery_time_unit" value="{{ old('delivery_time_unit' , $delivery->delivery_time_unit) }}">
                                </div>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control form-control-sm" id="status" name="status">
                                        <option value="0" {{ old('status' , $delivery->status) == 0 ? 'selected' : '' }}>غیرفعال</option>
